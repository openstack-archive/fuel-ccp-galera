...
def set_leader(etcd_client, ttl):

    key = os.path.join(ETCD_PATH, 'leader')
    _etcd_set(etcd_client, key, IPADDR, ttl)
...
def main(ttl):
    ...
    # I think we should use same lock as galera, to avoid possible races
